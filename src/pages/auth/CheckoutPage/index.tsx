...
import { ArrowLeft, BadgeDollarSign, Menu, Minus, Plus, ShoppingCart } from "lucide-react";
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        >
                            <div className="modal-box">
                                ...
                                <p className="py-4">
                                    All items has been removed. Looking for other options? FoodGuardian has many great restos you can try.
                                </p>
                                <div className="modal-action">
                                    <div className="w-full">
                                        <button
                                            className="btn btn-primary btn-block normal-case text-lg" onClick={() => navigate(-1)}
                                        >
                                            Back to resto page
                                        </button>
                                    </div>
