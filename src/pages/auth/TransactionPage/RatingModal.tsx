...
interface RatingModalProps {
    isOpenModal: boolean;
    closeModal: () => void;
    transactionId: string; // Pass the transaction ID as a prop
}
...
const RatingModal: React.FC<RatingModalProps> = ({
    ...
    const handleSendMessage = async () => {
        ...
        await transactionStore.handlePaymentComplete(transactionId, rating, comment);
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    >
                        <div className="modal-box">
                            ...
                            <div className="py-4">
                                <div className="mb-4">
                                    <label className="block font-bold text-lg mb-2">Rating:</label>
                                    <div>
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <span
                                                key={star}
                                ...
                                <div className="mb-4">
                                    <label className="block font-bold text-lg mb-2">Comment:</label>
                                    <input
                                        type="text"
